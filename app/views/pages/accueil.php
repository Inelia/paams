<?php require APPROOT . '/views/inc/head.php'; ?>
    ...
    <main class="main_home">
      ...
      <p class="text">
        ...
        photographe. Ils allient leurs disciplines artistiques et imaginent 
        alors un concept mode: Paam's.
        Ils se lancent dans l'aventure, créant vêtements et accessoires Pop 
